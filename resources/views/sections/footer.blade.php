    ...
    <div class="container">
        <div class="row">
            ...
            <div class="block widget_text col-md-3 col-sm-4">
                ...
                <p><strong>Horarska 12/A</strong>, 821 09 Bratislava<br>
                    <span><strong>Tel:</strong> </span>+421 949 754 510<br>
                    <span><strong>E-mail:</strong> </span>
                    <a href="mailto:info@zkdunajplavba.sk">info@zkdunajplavba.sk</a><br>
                </p>
                <p>
